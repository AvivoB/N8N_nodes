                ...
                if (resource === 'collection') {
                    if (operation === 'create') {
                        ...
                        const schema = typeof collectionSchema === 'string'
                            ...
                            : collectionSchema;
                        responseData = await GenericFunctions_1.typesenseApiRequest.call(this, 'POST', '/collections', schema);
                    }
                    else if (operation === 'get') {
                        const collectionName = this.getNodeParameter('collectionName', i);
                        responseData = await GenericFunctions_1.typesenseApiRequest.call(this, 'GET', `/collections/${collectionName}`);
                    }
                    else if (operation === 'getAll') {
                        responseData = await GenericFunctions_1.typesenseApiRequest.call(this, 'GET', '/collections');
                    }
                    else if (operation === 'delete') {
                        const collectionName = this.getNodeParameter('collectionName', i);
                        responseData = await GenericFunctions_1.typesenseApiRequest.call(this, 'DELETE', `/collections/${collectionName}`);
                    }
                        ...
                        const schema = typeof updateSchema === 'string'
                            ...
                            : updateSchema;
                        responseData = await GenericFunctions_1.typesenseApiRequest.call(this, 'PATCH', `/collections/${collectionName}`, schema);
                    }
                }
                    ...
                    if (operation === 'create') {
                        ...
                        const document = typeof documentData === 'string'
                            ...
                            : documentData;
                        responseData = await GenericFunctions_1.typesenseApiRequest.call(this, 'POST', `/collections/${collectionName}/documents`, document);
                    }
                    else if (operation === 'get') {
                        const documentId = this.getNodeParameter('documentId', i);
                        responseData = await GenericFunctions_1.typesenseApiRequest.call(this, 'GET', `/collections/${collectionName}/documents/${documentId}`);
                    }
                    else if (operation === 'update') {
                        const documentId = this.getNodeParameter('documentId', i);
                        const documentData = this.getNodeParameter('documentData', i);
                        const document = typeof documentData === 'string'
                            ? JSON.parse(documentData)
                            : documentData;
                        responseData = await GenericFunctions_1.typesenseApiRequest.call(this, 'PATCH', `/collections/${collectionName}/documents/${documentId}`, document);
                    }
                        ...
                        const document = typeof documentData === 'string'
                            ? JSON.parse(documentData)
                            : documentData;
                        responseData = await GenericFunctions_1.typesenseApiRequest.call(this, 'POST', `/collections/${collectionName}/documents?action=upsert`, document);
                    }
                    else if (operation === 'delete') {
                        const documentId = this.getNodeParameter('documentId', i);
                        responseData = await GenericFunctions_1.typesenseApiRequest.call(this, 'DELETE', `/collections/${collectionName}/documents/${documentId}`);
                    }
                }
                    ...
                    if (operation === 'search') {
                        ...
                        const queryBy = this.getNodeParameter('queryBy', i);
                        ...
                        responseData = await GenericFunctions_1.typesenseApiRequest.call(this, 'GET', `/collections/${collectionName}/documents/search`, {}, searchParams);
                    }
                        ...
                        const queries = typeof searchQueries === 'string'
                            ...
                            : searchQueries;
                        responseData = await GenericFunctions_1.typesenseApiRequest.call(this, 'POST', '/multi_search', queries);
                    }
                }
